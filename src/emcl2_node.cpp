...
namespace emcl2
{
    /* Class */
    //! コンストラクタ
    EMcl2Node::EMcl2Node() : Node("emcl2_node"), ros_clock_(RCL_SYSTEM_TIME), init_request_(false), simple_reset_request_(false), scan_receive_(false), map_receive_(false)
    {
    ...
    void EMcl2Node::initCommunication(void)
    {
        ...
        /* Subscriber */
        //! scan
        laser_scan_sub_ = create_subscription<sensor_msgs::msg::LaserScan>("scan", 2, std::bind(&EMcl2Node::cbScan, this, std::placeholders::_1));
        //! initialpose
        initial_pose_sub_ = create_subscription<geometry_msgs::msg::PoseWithCovarianceStamped>("initialpose", 2, std::bind(&EMcl2Node::initialPoseReceived, this, std::placeholders::_1));
        //! map
        map_sub_ = create_subscription<nav_msgs::msg::OccupancyGrid>("map", rclcpp::QoS(rclcpp::KeepLast(1)).transient_local().reliable(), std::bind(&EMcl2Node::receiveMap, this, std::placeholders::_1));

        /* Service */
        //! global_localization
        global_loc_srv_ = create_service<std_srvs::srv::Empty>("global_localization", std::bind(&EMcl2Node::cbSimpleReset, this, std::placeholders::_1, std::placeholders::_2));
    ...
    /* Publish */
    void EMcl2Node::publishPose(double x, double y, double t, double x_dev, double y_dev, double t_dev, double xy_cov, double yt_cov, double tx_cov)
    {
    ...
    bool EMcl2Node::cbSimpleReset(const std_srvs::srv::Empty::Request::ConstSharedPtr, std_srvs::srv::Empty::Response::SharedPtr)
    {
